        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelefonoFijo = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: true),
                    Celular = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: true),
                    FamiliaId = table.Column<int>(type: "int", nullable: true),
                    MetodoDePagoSugeridoId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.MetodoDePagoSugeridoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clientes_MetodoDePagoSugeridoId",
                table: "Clientes",
                column: "MetodoDePagoSugeridoId");

            migrationBuilder.CreateIndex(
                name: "IX_Clientes_Nombres_Apellidos",
                table: "Clientes",
